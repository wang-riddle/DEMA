...
write.csv(MSE.EST,"est1_1.csv")
write.csv(MSE.EST.SD,"estsd1_1.csv")
write.csv(MSE.PRE,"pre1_1.csv")
write.csv(MSE.PRE.SD,"presd1_1.csv")
write.csv(WEIGHT,"weight1_1.csv")
